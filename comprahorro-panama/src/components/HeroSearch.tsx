    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 pt-16 pb-20 md:pt-24 md:pb-28">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-3 text-muted-foreground text-base md:text-lg max-w-md mx-auto">
            <p>Compara opciones en tiempo real</p>
            <p>Compra directo, sin intermediarios ni presiones</p>
            <p>Tú eliges con un clic tu opción.</p>
          </div>
